 ...
 */
@WebServlet(asyncSupported = true, urlPatterns = { "/registerationController" })
public class RegisterationController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("WEB-INF/pages/registeration.jsp").forward(request, response);
	}
