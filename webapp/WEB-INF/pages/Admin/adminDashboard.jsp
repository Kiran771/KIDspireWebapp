		...
		<main>
			...
			<div class="box-info">
				...
				<div class="info">
					<i class='bx bx-registered icon-registered' ></i>
					<div class="data">
						<h4>New Babysitter</h4>
						<h3>${newBabysitters}</h3>
					</div>
				</div>
				<div class="info">
			...
			<div class="button">
				<a href="${pageContext.request.contextPath}/babysitterMngController?action=add" class="btn btn-primary">Add Babysitter</a>
			</div>
				<table>
					<thead>
						<tr>
					 ...
					 <tbody id="babysitterTableBody">
						<c:forEach var="babysitter" items="${babysitters}">
							<tr>
								...
								<td>
									<a href="${pageContext.request.contextPath}/babysitterMngController?action=edit&babysitterId=${babysitter.babysitterId}" 
									   class="btn btn-edit"><i class="fa-regular fa-pen-to-square"></i></a>
									 <form action="${pageContext.request.contextPath}/babysitterMngController" method="post" style="display:inline;">
	                                	<input type="hidden" name="action" value="delete">
	                                	<input type="hidden" name="babysitterId" value="${babysitter.babysitterId}">
	                                	<button type="submit" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete ${babysitter.name}?')" aria-label="Delete babysitter">
