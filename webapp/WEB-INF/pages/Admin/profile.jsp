	...
	<div class="myProfile">
		...
		<div class="profileInfo">
			...
			<div class="personalDetailsContainer">
				...
				<div class="personalDetails">
					<h4>First Name</h4>
					<input type="text" id="firstName" name="firstName" value="${firstName != null ? firstName : user.firstName}" required>
			...
			<div class="personalDetailsContainer">
				<div class="personalDetails">
					<h4>Last Name</h4>
					<input type="text" id="lastName" name="lastName"value="${lastName!=null? lastName: user.lastName}" required>
			...
			<div class="personalDetailsContainer">
				<div class="personalDetails">
					...
					<input type="text" id="cNumber" name="cNumber" value="${cNumber!= null ? cNumber:user.contactNumber}"required>
				...
				<div class="personalDetails">
					<h4>Email</h4>
					<input type="text" id="email" name="email" value="${email!=null? email: user.email}"required>
