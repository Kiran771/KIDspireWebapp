...
<footer class=footer>
	<div class="footerContainer">
		<div class="footerContent">
			<h2><span style='color:rgb(134, 184, 186);margin-bottom:.3rem;margin-right:2.3rem'>KIDspire.</span></h2>
		...
		<div class="footerContent">
			...
			<ul class="quickLinks">
				...
				<li><a href="{$pageContext.request.contextPath}/pages/babysitter.jsp">Babysitter</a></li>
				<li><a href="{$pageContext.request.contextPath}/pages/blog.jsp">Blog</a></li>
