...
<body>
	<header class="header">
		...
		<ul>
			...
			<li><a
				href="${pageContext.request.contextPath}/babysitterController">Babysitter</a></li>
			<li><a href="${pageContext.request.contextPath}/blogController">Blog</a></li>
			<li><a
				href="${pageContext.request.contextPath}/aboutusController">About
					us</a></li>
			<li><a
				href="${pageContext.request.contextPath}/contactUsController">Contact
					us</a></li>
