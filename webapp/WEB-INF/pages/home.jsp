...
<body>
	...
	<div class="imageContainer">
		<div class="tagline">
            ...
            <p>Find and book the best babysitters near you in just a few clicks!</p>
	...
	<div class="serviceContainer">
		...
		<div class="serviceSpace">
			<div class="services">
				...
				<p>Book a babysitter with just a few clicks — it's fast and hassle-free</p>
				
			</div>
			<div class="services">
				<i class="fa-solid fa-star" style="color: #FFD43B;"></i>
				<h2>Real Reviews</h2>
				<p>Read genuine feedback from other parents to make confident decisions</p>
				
			</div>
			<div class="services">
				<i class="fa-regular fa-circle-check" style="color: #38571a;"></i>
				<h2>Safe and Verified Sitters</h2>
				<p>All sitters are background-checked and verified for your peace of mind</p>
	...
	<div class="topBabysitterContainer">
		...
		<div class="sliderWrapper">
			<button class="sliderArrow leftArrow"><i class="fa-solid fa-chevron-left"></i></button>
			...
			<button class="sliderArrow rightArrow"><i class="fa-solid fa-chevron-right"></i></button>
		</div>
  </div>
  <div class=getInTouchContainer>
  	<div class="inputImageSpace">
	  	<div class="pictures">
	  		<img src="${pageContext.request.contextPath}/resources/contactUs1.jpg">
  ...
  <script src="${pageContext.request.contextPath}/js/horizontalImgSlider.js"></script>
